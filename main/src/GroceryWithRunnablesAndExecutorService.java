...
/**
 * Demonstration of the grocery store using {@link Runnable} interface and {@link java.util.concurrent.ExecutorService}
 */
public class GroceryWithRunnablesAndExecutorService {
    ...
    public static void main(String[] args) {
        ...
        // Service which creates threads if no threads available, and re-uses previous ones if they are free
        ExecutorService executorService = Executors.newCachedThreadPool();

        Runnable alice = new CashierRunnable(4, "Alice");
        executorService.submit(alice);
        ...
        executorService.submit(bob);
        executorService.submit(chris);
        ...
        // Executor service need to be shut down
